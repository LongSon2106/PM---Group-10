...
<div class="wrapper row4">
    <figure class="clients">
        <!-- ################################################################################################ -->
        <ul class="clear">
            <li><a href="pages/gallery.jsp?page=1&action=getcate&namepage=Iphone"><img src="/images/demo/logos/1.jpg" alt=""></a></li>
            <li><a href="pages/gallery.jsp?page=1&action=getcate&namepage=Ipad"><img src="/images/demo/logos/2.jpg" alt=""></a></li>
            <li><a href="pages/gallery.jsp?page=1&action=getcate&namepage=Watch"><img src="/images/demo/logos/3.jpg" alt=""></a></li>
            <li><a href="pages/gallery.jsp?page=1&action=getcate&namepage=Mac"><img src="/images/demo/logos/4.jpg" alt=""></a></li>
            <li><a href="pages/gallery.jsp?page=1&action=getcate&namepage=TV"><img src="/images/demo/logos/5.jpg" alt=""></a></li>
        </ul>
        <!-- ################################################################################################ -->
    </figure>
</div>
